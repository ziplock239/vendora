...
import { c as Route, a as useAuth, b as useQueryClient, t as toast, s as supabase, L as Link } from "./router-DsUVh2gx.js";
import { j as createLucideIcon, i as cn, B as Button, u as useQuery, M as MainLayout, k as Store, l as ShoppingCart } from "./main-layout-7G5etEiH.js";
...
function ProductDetailPage() {
  ...
  const {
    ...
    queryFn: async () => {
      const {
        data,
        error
      } = await supabase.from("products").select("*, profiles:seller_id(full_name), categories(name,slug)").eq("id", productId).maybeSingle();
  ...
  const addToCart = useMutation({
    mutationFn: async () => {
      ...
      const {
        data: existing
      } = await supabase.from("cart_items").select("id,qty").eq("user_id", user.id).eq("product_id", productId).maybeSingle();
      if (existing) {
        const {
          error
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(MainLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-96 animate-pulse rounded-2xl bg-muted" }) }) });
  }
  if (!product) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(MainLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-16 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/products", className: "mt-4 inline-block text-primary hover:underline", children: "Browse all products" })
    ] }) });
  }
  const images = Array.isArray(product.images) ? product.images : [];
  const sellerName = product.profiles?.full_name || "Verified seller";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(MainLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto grid gap-8 px-4 py-8 md:grid-cols-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      images.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Carousel, { setApi: (a) => setApi(a ?? null), className: "w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselContent, { children: images.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square overflow-hidden rounded-2xl bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src, alt: `${product.title} ${i + 1}`, className: "h-full w-full object-cover" }) }) }, i)) }),
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square overflow-hidden rounded-2xl bg-muted flex items-center justify-center text-muted-foreground", children: "No image" }),
      images.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex gap-2 overflow-x-auto", children: images.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
        setActiveImg(i);
        api?.scrollTo(i);
      }, className: `h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg border-2 ${i === activeImg ? "border-primary" : "border-border"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src, alt: "", className: "h-full w-full object-cover" }) }, i)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold", children: product.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-3xl font-bold text-primary", children: formatNaira(product.price_kobo) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 whitespace-pre-line text-muted-foreground", children: product.description }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex items-center gap-3 rounded-xl border border-border bg-card p-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: sellerName })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "lg", className: "mt-6 w-full", onClick: () => addToCart.mutate(), disabled: addToCart.isPending, children: [
