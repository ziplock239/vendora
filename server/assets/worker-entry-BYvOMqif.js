...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BQyikXjM.js");
...
const manifest = {
  "5a1dfc4d21b97a1048b739925b4dee5a019b27b884f10a9e3adb076e26bf7577": {
    functionName: "initializePayment_createServerFn_handler",
    importer: () => import("./paystack.functions-B_eayZSi.js")
  },
  "15a7a42012cba1368b9d5f93c54163506e35c688cadabf6086dc771bf7c5ad5d": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DsUVh2gx.js").then((n2) => n2.B),
